...
"""
            ...
            <div class="quick-actions">
                <strong style="font-size: 12px; color: #777;">Quick Actions:</strong><br>
                <a href="https://to-do.office.com/tasks/id/{task_id}/details" class="action-btn" title="Open in Microsoft To Do">📱 Open Task</a>
                <span class="action-btn complete" style="cursor: default;" title="Mark as complete in Microsoft To Do">✓ Complete</span>
                <span class="action-btn snooze" style="cursor: default;" title="Snooze until tomorrow">⏰ Snooze</span>
                <span class="action-btn priority" style="cursor: default;" title="Escalate priority">⬆️ Escalate</span>
            </div>
"""
...
"""
        ...
        <div class="footer">
            ...
            <p style="margin-top: 10px; font-size: 12px; color: #999;">
                <em>Note: Quick Actions are informational. Update tasks in Microsoft To Do or via the app.</em>
            </p>
