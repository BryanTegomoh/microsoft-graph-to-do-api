...
"""
            ...
            # Add Quick Actions with deep link
            # Microsoft To Do deep link format: ms-to-do://tasks/id/{task_id}
            # This opens the native app on iPhone/Windows, falls back to web on other devices
            deep_link = f"ms-to-do://tasks/id/{task_id}"
            web_fallback = f"https://to-do.office.com/tasks/id/{task_id}/details"

            html += f"""
            <div class="quick-actions">
                <strong style="font-size: 12px; color: #777;">Quick Action:</strong><br>
                <a href="{deep_link}" class="action-btn" title="Open in Microsoft To Do app (iPhone/Windows) or web">📱 Open in To Do App</a>
                <small style="display: block; margin-top: 8px; color: #999; font-size: 11px;">
                    Opens native app on iPhone/Windows • <a href="{web_fallback}" style="color: #3498db;">Open in web</a> if app doesn't launch
                </small>
            </div>
"""
...
"""
        ...
        <div class="footer">
            ...
            <p style="margin-top: 10px; font-size: 12px; color: #999;">
                <em>💡 Tip: Click "Open in To Do App" to view and manage tasks directly in your Microsoft To Do app</em>
            </p>
